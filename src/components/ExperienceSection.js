...
export default function ExperienceSection() {
    return (
      <section className="flex flex-col items-center justify-center mb-[4em]">
        <div>
             {/* Left Image Section */}
                      <article className="flex flex-col md:flex-row items-center justify-between py-10 relative w-full max-w-screen-lg" >

              <div className="w-[20em] h-[20em] after:content-[''] after:absolute after:left-1/2 after:bottom-0 after:w-[50%] after:h-[2px] after:bg-[#D3DEE8] after:-translate-x-1/2 mb-6 md:mb-0 mr-10"
              >  
                  <Image
                    src={family}
                    alt="Family mage"
              ...
              <article className="flex flex-col md:flex-row gap-[2em] mt-[2em] justify-center w-full max-w-screen-lg">
