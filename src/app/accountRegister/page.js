...
//               <label htmlFor="fName" className="text-sm mb-2">
//                 Fulde navn
//               </label>
//               <input
//                 type="text"
...
//               <label htmlFor="fRepass" className="text-sm mb-2">
//                 Bekræft password
//               </label>
//               <input
//                 type="password"
...
//       if (data.jwt) {
//         setSuccessMessage("Bruger er oprettet!");
//         setFormData({ fullName: "", email: "", password: "", confirmPassword: "" });
//       } else {
//         setErrors({ server: "Noget gik galt, prøv igen." });
//       }
//     } catch (error) {
//       setErrors({ server: "Noget gik galt på serveren." });
//     }
//   };
...
//             <div className="flex flex-col mb-4">
//               <label htmlFor="fullName" className="text-sm mb-2">Fulde navn</label>
//               <input
//                 type="text"
//                 id="fullName"
...
//             <div className="flex flex-col mb-4">
//               <label htmlFor="email" className="text-sm mb-2">Email adresse</label>
//               <input
//                 type="email"
//                 id="email"
...
//             <div className="flex flex-col mb-6">
//               <label htmlFor="confirmPassword" className="text-sm mb-2">Bekræft password</label>
//               <input
//                 type="password"
//                 id="confirmPassword"
